    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── Logo area ── */
        .logo-area { display: flex; flex-direction: column; align-items: center; gap: 14px; margin-bottom: 24px; }
        ...
        /* ── Card ── */
        .card { background: var(--surface); border: 1.5px solid var(--border); border-radius: 24px; padding: 26px 24px; box-shadow: var(--shadow); }
        ...
        @media (max-height: 740px) {
          .logo-area { margin-bottom: 16px; gap: 10px; }
