  ...
  return (
    ...
    >
      <defs>
        ...
        <filter id="lg3-reg" x="-20%" y="-20%" width="140%" height="140%">
          <feGaussianBlur stdDeviation="1.5" result="blur" />
          <feComposite in="SourceGraphic" in2="blur" operator="over" />
        </filter>
      </defs>
      <rect width="56" height="56" rx="16" fill="url(#lg-reg)" />
      <rect
        x="3"
        y="3"
        width="50"
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        :root {
          ...
          --shadow:0 4px 32px rgba(58,173,160,0.16); --shadow-sm:0 2px 12px rgba(58,173,160,0.11);
        ...
        .logo-ring-2 { animation-delay:0.9s; } .logo-ring-3 { animation-delay:1.8s; }
