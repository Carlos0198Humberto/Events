...
function getStrength(pass: string): {
  ...
  return { level: 4, label: "Fuerte", color: "#4F46E5" };
}
...
export default function Registro() {
  ...
  useEffect(() => {
    document.title = "Evorix — Crear cuenta";
    setMounted(true);
  }, []);
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logo-ring { position: absolute; border-radius: 50%; border: 1.5px solid rgba(79,70,229,0.18); animation: ringExpand 3s ease-out infinite; width: 62px; height: 62px; }
        ...
        .terms-row.active { border-color: var(--accent); background: rgba(79,70,229,0.08); }
        .checkbox-box {
