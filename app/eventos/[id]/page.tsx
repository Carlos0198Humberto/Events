  ...
  const styles = `
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    :root{
      ...
      --border:rgba(79,70,229,0.25);--border-mid:rgba(79,70,229,0.40);
    ...
    /* ── Topbar ── */
    .topbar{display:flex;align-items:center;gap:10px;padding:11px 16px;background:rgba(255,255,255,0.92);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border-bottom:1px solid var(--border);position:sticky;top:env(safe-area-inset-top,0px);z-index:20;justify-content:space-between;width:100%;box-sizing:border-box;}
    ...
    .topbar-num{
      ...
      color:var(--gold);border:1px solid rgba(79,70,229,0.3);
    ...
    .btn-salir-muro:hover{background:var(--dark);color:var(--gold);border-color:rgba(79,70,229,0.5)}
    ...
    .inv-num-badge{
      ...
      background:rgba(79,70,229,0.22);border:1px solid rgba(79,70,229,0.6);
      border-radius:99px;padding:4px 13px;
      font-size:11px;font-weight:800;color:rgba(99,102,241,1);
      letter-spacing:1px;text-transform:uppercase;
      margin-bottom:10px;
    }

    .inv-tipo-badge{position:relative;z-index:2;display:inline-flex;align-items:center;gap:6px;background:rgba(79,70,229,0.18);border:1px solid rgba(79,70,229,0.55);border-radius:99px;padding:5px 14px;font-family:'Jost',sans-serif;font-size:10px;font-weight:700;color:rgba(99,102,241,1);letter-spacing:1.5px;text-transform:uppercase;margin-bottom:14px;text-shadow:0 1px 4px rgba(0,0,0,0.5);}
    ...
    .inv-anfitrion{position:relative;z-index:2;font-size:12px;color:rgba(99,102,241,0.92);font-weight:500;letter-spacing:.5px;margin-bottom:16px;text-shadow:0 1px 6px rgba(0,0,0,0.7);}
    .inv-evento-nombre{position:relative;z-index:2;background:rgba(26,18,9,0.65);backdrop-filter:blur(8px);border:1px solid rgba(79,70,229,0.55);border-radius:12px;padding:12px 22px;font-family:'Cormorant Garamond',serif;font-size:22px;font-weight:600;color:#fff;letter-spacing:.3px;text-shadow:0 1px 8px rgba(0,0,0,0.6);}
    ...
    .lightbox-nav{position:absolute;top:50%;transform:translateY(-60%);width:40px;height:40px;border-radius:50%;background:rgba(26,18,9,0.7);border:1.5px solid rgba(79,70,229,0.3);cursor:pointer;display:flex;align-items:center;justify-content:center;transition:background .15s}
    ...
    .conf-check{position:relative;z-index:1;width:72px;height:72px;border-radius:50%;background:rgba(79, 70, 229,0.15);border:1.5px solid rgba(79, 70, 229,0.45);display:flex;align-items:center;justify-content:center;margin:0 auto 20px;animation:popIn .55s .1s cubic-bezier(.22,1,.36,1) both}
    ...
    .conf-sub{position:relative;z-index:1;font-size:13px;color:rgba(99, 102, 241,0.7);font-weight:400}
    .conf-body{padding:22px;display:flex;flex-direction:column;gap:16px}
    .num-badge{background:linear-gradient(135deg,var(--dark),var(--dark2));border-radius:var(--r-sm);border:1px solid rgba(79, 70, 229,0.3);padding:16px 20px;display:flex;align-items:center;gap:16px}
    .num-icono{width:46px;height:46px;border-radius:12px;background:rgba(79, 70, 229,0.12);border:1px solid rgba(79, 70, 229,0.25);display:flex;align-items:center;justify-content:center;flex-shrink:0}
    .num-label{font-size:9px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:rgba(79, 70, 229,0.6);margin-bottom:3px}
    ...
    .btn-cerrar:hover{background:var(--dark);color:var(--gold);border-color:rgba(79, 70, 229,0.4)}
    ...
    .loading-spinner{width:36px;height:36px;border-radius:50%;border:2.5px solid rgba(79, 70, 229,0.15);border-top-color:var(--gold);animation:spin .75s linear infinite}
    ...
    @media (max-width: 420px){
      ...
      .topbar-num{font-size:10px;padding:3px 8px}
      .btn-salir-muro{padding:6px 10px;font-size:11px}
      .wrap{padding:18px 13px;gap:16px}
      .inv-hero{padding:32px 18px 26px;min-height:260px}
      .inv-saludo{font-size:32px}
      .inv-anfitrion{font-size:11px}
      .inv-evento-nombre{font-size:19px;padding:10px 16px}
      .inv-body{padding:18px 16px;gap:14px}
      .inv-frase{font-size:15.5px;padding:2px 4px}
      .inv-nombres{padding:12px 14px}
      .paso-progress{padding:10px 13px;gap:8px}
      .paso-dot{width:22px;height:22px;font-size:9.5px}
    }
    @media (max-width: 340px){
      .topbar-name{font-size:16px}
      .inv-saludo{font-size:28px}
      .inv-evento-nombre{font-size:17px}
    }
  `;
            ...
            <div className="conf-card">
              <div className="conf-hero">
                ...
                <p className="conf-sub">
                  Nos vemos en{" "}
                  <strong
                    style={{ color: "rgba(99, 102, 241,0.95)", fontWeight: 500 }}
                  >
                    {evento.nombre}
                  </strong>
                </p>
