    ...
    <>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── Language button ── */
        .controls { position: absolute; top: 12px; right: 12px; z-index: 20; }
        .ctrl-btn {
        ...
        .mounted .anim-logo     { animation: mountUp 0.7s cubic-bezier(.22,1,.36,1) 0.10s both; }
        .mounted .anim-name     { animation: mountUp 0.6s cubic-bezier(.22,1,.36,1) 0.24s both; }
        .mounted .anim-tag      { animation: mountUp 0.5s cubic-bezier(.22,1,.36,1) 0.36s both; }
        .mounted .anim-btn      { animation: mountUp 0.6s cubic-bezier(.22,1,.36,1) 0.50s both; }
        .mounted .anim-features { animation: mountUp 0.5s cubic-bezier(.22,1,.36,1) 0.62s both; }
        ...
        /* ── Feature pills ── */
        .features-strip {
          display: flex; gap: 7px; margin-bottom: 34px;
        ...
        .feat-pill:nth-child(1){animation:pillAppear .5s .70s both}
        .feat-pill:nth-child(2){animation:pillAppear .5s .78s both}
        .feat-pill:nth-child(3){animation:pillAppear .5s .86s both}
        .feat-pill:nth-child(4){animation:pillAppear .5s .94s both}
        .feat-pill:hover { background: var(--accent-soft2); border-color: var(--border-hover); color: var(--accent); transform: translateY(-2px); }
        .feat-dot { width: 5px; height: 5px; border-radius: 50%; background: var(--accent-light); flex-shrink: 0; animation: dotPulse 2s ease-in-out infinite; }
        ...
        @keyframes pillAppear { from{opacity:0;transform:translateY(10px) scale(0.94)} to{opacity:1;transform:translateY(0) scale(1)} }
        ...
        /* ── Auth screen ── */
        .auth-inner { width:100%; max-width:340px; display:flex; flex-direction:column; align-items:center; }
        .auth-header { display:flex; flex-direction:column; align-items:center; margin-bottom:32px; gap:12px; animation:fadeUp .4s ease both; }
        .auth-title { font-family:'Cormorant Garamond',serif; font-size:26px; font-weight:600; color:var(--text); text-align:center; letter-spacing:-.5px; line-height:1.2; }

        .auth-cards { display:flex; flex-direction:column; gap:11px; width:100%; animation:fadeUp .4s .08s ease both; }
        .auth-card {
        ...
        .auth-card-icon { width:40px; height:40px; border-radius:13px; background:var(--accent-soft2); display:flex; align-items:center; justify-content:center; color:var(--accent); flex-shrink:0; transition:var(--transition); }
        ...
        .back-btn {
          ...
          margin-top:24px; padding:8px 4px;
        ...
        .footer-copy span {
          ...
          text-transform:uppercase; color:var(--text3); opacity:0.65;
          font-family:'DM Sans',sans-serif;
        }

        /* ── Very small screens (<360px) ── */
        @media (max-width: 359px) {
          .logo-name { font-size: 33px; }
          .logo-container { width: 80px; height: 80px; }
          .btn-main { padding: 14px 32px; font-size: 14px; }
          .auth-card { padding: 15px 16px; border-radius: 17px; }
        }

        /* ── Short screens / landscape ── */
        @media (max-height: 640px) {
          .logo-wrap { margin-bottom: 20px; gap: 10px; }
          .logo-container { width: 72px; height: 72px; }
          .logo-ring { width: 60px; height: 60px; }
          .logo-name { font-size: 32px; }
          .logo-tag { display: none; }
          .features-strip { margin-bottom: 20px; gap: 5px; }
          .feat-pill { padding: 5px 10px; font-size: 10.5px; }
        ...
        @media (max-height: 500px) {
          ...
          .features-strip { margin-bottom: 14px; }
      ...
      <div className={`app${mounted ? " mounted" : ""}`}>
        ...
        >
          ...
          <div className="anim-btn">
            <button className="btn-main" onClick={() => goTo("auth")}>
        ...
        >
          <div className="auth-inner">
            ...
            <div className="auth-cards">
              ...
              <Link href="/auth/registro" className="auth-card primary">
                <div className="auth-card-left">
                  ...
                  <span className="auth-card-sub">{t.newHere}</span>
                </div>
              ...
              <Link href="/auth/login" className="auth-card">
                <div className="auth-card-left">
                  ...
                  <span className="auth-card-sub">{t.haveAccount}</span>
                </div>
                <div className="auth-card-icon">
                  <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                    <circle
            ...
            <button className="back-btn" onClick={() => goTo("splash")}>
