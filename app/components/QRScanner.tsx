  ...
  return (
    <>
      <style>{`
        ...
        .qr-topbar-title{font-family:'Cormorant Garamond',serif;font-size:22px;font-style:italic;color:#F5EDD8}
        ...
        .qr-frame{position:absolute;inset:14%;border-radius:12px;border:2.5px solid rgba(201,169,110,0.8);box-shadow:0 0 0 9999px rgba(0,0,0,0.45)}
        .qr-scanline{position:absolute;left:14%;right:14%;height:3px;background:linear-gradient(90deg,transparent,rgba(201,169,110,0.9),transparent);border-radius:2px;animation:qrScan 2s ease-in-out infinite}
        .qr-corner{position:absolute;width:24px;height:24px;border-color:var(--gold,#C9A96E);border-style:solid}
        ...
        .qr-hint{font-size:12px;color:rgba(201,169,110,0.65);text-align:center;letter-spacing:.3px}
        .qr-loading{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;padding:40px 0}
        .qr-spinner{width:40px;height:40px;border-radius:50%;border:3px solid rgba(201,169,110,0.2);border-top-color:#C9A96E;animation:spin .75s linear infinite}
        ...
        .qr-result-name{font-family:'Cormorant Garamond',serif;font-size:28px;font-weight:600;color:#F5EDD8;margin-bottom:4px}
        .qr-result-sub{font-size:12px;color:rgba(201,169,110,0.65);margin-bottom:20px}
        .qr-result-personas{display:inline-flex;align-items:center;gap:7px;background:rgba(201,169,110,0.12);border:1px solid rgba(201,169,110,0.25);border-radius:99px;padding:6px 14px;font-size:12px;font-weight:600;color:rgba(201,169,110,0.8);margin-bottom:20px}
        ...
        <div className="qr-sheet">
          ...
          {status === "scanning" && (
            <>
              <div className="qr-viewport">
                {camError ? (
                  <div style={{ display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",height:"100%",gap:12,color:"rgba(201,169,110,0.7)",fontSize:13,textAlign:"center",padding:20 }}>
          ...
          {status === "loading" && (
            <div className="qr-loading">
              ...
              <span style={{ fontSize:13, color:"rgba(201,169,110,0.65)" }}>Verificando invitado...</span>
            </div>
          )}
