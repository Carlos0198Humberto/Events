  ...
  return (
    <>
      <style>{`
        ...
        .fs-icon-wrap{width:48px;height:48px;border-radius:13px;background:rgba(79, 70, 229,0.12);border:1px solid rgba(79, 70, 229,0.25);display:flex;align-items:center;justify-content:center;flex-shrink:0}
        .fs-title{font-size:16px;font-weight:700;color:#F8FAFC;line-height:1.2;margin-bottom:3px}
        .fs-sub{font-size:12px;color:rgba(79, 70, 229,0.65);line-height:1.4}
        ...
        .fs-step-num{width:24px;height:24px;border-radius:50%;background:rgba(79, 70, 229,0.15);border:1px solid rgba(79, 70, 229,0.3);display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:11px;font-weight:700;color:rgba(79, 70, 229,0.85)}
        .fs-step-text{font-size:13px;color:rgba(99, 102, 241,0.8);line-height:1.5;padding-top:3px}
      ...
      <div className="fs-sheet" role="dialog" aria-label="Ver en pantalla completa">
        ...
        <div className="fs-row">
          <div className="fs-icon-wrap">
            ...
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="rgba(79, 70, 229,0.9)" strokeWidth="1.8" strokeLinecap="round">
        ...
        <div className="fs-steps">
          <div className="fs-step">
            ...
            <div className="fs-step-text">
              ...
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="rgba(79, 70, 229,0.75)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ display:"inline", verticalAlign:"middle", marginBottom:1 }}>
          ...
          <div className="fs-step">
            ...
            <div className="fs-step-text">
              Abre Evorix desde tu pantalla de inicio — se verá sin ninguna barra
            </div>
          </div>
        </div>
